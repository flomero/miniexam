...
# Setup variables
EXERCISE_DIR="code/ex05"
EXERCISE_FILE="ex05.c"
MAIN_FILE=".tests/ex05/main.c"
EXECUTABLE="test_executable"
EXPECTED_FILE=".tests/ex05/05.expected"
OUTPUT_FILE="output.tmp"
TEST_INPUTS=("hello+world" "baum+" "test+123" "+baum" "")
CURRENT_EXERCISE_NUMBER="05"
NEXT_EXERCISE_NUMBER="06"
