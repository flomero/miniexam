...
run_tests_with_multible_arguments "$EXECUTABLE" "$OUTPUT_FILE" "${TEST_INPUTS1[@]}"
run_tests_with_multible_arguments "$EXECUTABLE" "$OUTPUT_FILE" "${TEST_INPUTS2[@]}"
